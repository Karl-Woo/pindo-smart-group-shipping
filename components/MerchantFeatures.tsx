...
const MerchantFeatures: React.FC = () => {
  return (
    <section id="features-merchant" className="py-20 bg-slate-900 text-white relative overflow-hidden">
          ...
          <div className="flex-1">
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">地理位置精准获客</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">标准化发货流程</h3>
                  <p className="text-slate-400 text-sm">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">智能分账与支付</h3>
                  <p className="text-slate-400 text-sm">
              ...
              <div className="bg-slate-50 rounded-lg border border-slate-200 overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="w-full bg-white border border-slate-200 rounded-lg overflow-hidden">
                    <div className="bg-slate-100 px-4 py-2 flex text-xs font-bold text-slate-500 border-b border-slate-200">
                      <div className="w-1/4">团名称</div>
                      <div className="w-1/4">状态</div>
                      <div className="w-1/4">进度</div>
                      <div className="w-1/4 text-right">操作</div>
                    </div>
                    <div className="px-4 py-3 flex items-center text-sm border-b border-slate-100">
                      <div className="w-1/4 font-medium text-slate-800">JSQ 空运普货</div>
                      <div className="w-1/4"><span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-xs">进行中</span></div>
                      <div className="w-1/4 text-slate-500">85%</div>
                      <div className="w-1/4 text-right text-brand-600 cursor-pointer">管理</div>
                    </div>
                    <div className="px-4 py-3 flex items-center text-sm border-b border-slate-100">
                      <div className="w-1/4 font-medium text-slate-800">LIC 海运团</div>
                      <div className="w-1/4"><span className="bg-orange-100 text-orange-700 px-2 py-0.5 rounded text-xs">待支付</span></div>
                      <div className="w-1/4 text-slate-500">100%</div>
                      <div className="w-1/4 text-right text-brand-600 cursor-pointer">催付</div>
                    </div>
                    <div className="px-4 py-3 flex items-center text-sm">
                      <div className="w-1/4 font-medium text-slate-800">曼岛加急</div>
                      <div className="w-1/4"><span className="bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs">已发货</span></div>
                      <div className="w-1/4 text-slate-500">-</div>
                      <div className="w-1/4 text-right text-brand-600 cursor-pointer">查看</div>
                    </div>
                  </div>
                </div>
              </div>
