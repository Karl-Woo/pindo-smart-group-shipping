        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold text-slate-800 mb-6 flex items-center gap-2">
              <span className="bg-slate-200 text-slate-600 p-2 rounded-lg text-sm">传统方式</span>
              微信群接龙
            </h3>
          ...
          <div className="bg-brand-50 rounded-2xl p-8 border border-brand-100 relative overflow-hidden shadow-lg group">
            ...
            <h3 className="text-2xl font-bold text-brand-900 mb-6 flex items-center gap-2">
              <span className="bg-brand-200 text-brand-800 p-2 rounded-lg text-sm">Pindo 拼岛 模式</span>
              智能平台化
            </h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
